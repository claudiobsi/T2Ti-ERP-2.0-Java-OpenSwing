 ...
 */
        package br.inf.portalfiscal.www.cte.wsdl.cterecepcao;
    ...
    private void populateAxisService() throws org.apache.axis2.AxisFault {
     ...
     _service = new org.apache.axis2.description.AxisService("CteRecepcao" + getUniqueSuffix());
    ...
    public CteRecepcaoStub(org.apache.axis2.context.ConfigurationContext configurationContext,
   ...
   public CteRecepcaoStub(org.apache.axis2.context.ConfigurationContext configurationContext,
     ...
     * Default Constructor
     */
    public CteRecepcaoStub(org.apache.axis2.context.ConfigurationContext configurationContext) throws org.apache.axis2.AxisFault {
        
                    this(configurationContext,"https://cte-homologacao.svrs.rs.gov.br/ws/cterecepcao/CteRecepcao.asmx" );
    ...
    public CteRecepcaoStub() throws org.apache.axis2.AxisFault {
                    ...
                    this("https://cte-homologacao.svrs.rs.gov.br/ws/cterecepcao/CteRecepcao.asmx" );
     ...
     */
    public CteRecepcaoStub(java.lang.String targetEndpoint) throws org.apache.axis2.AxisFault {
        this(null,targetEndpoint);
                     ...
                     * 
                     * @see br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcao#cteRecepcaoLote
                     * @param cteDadosMsg0
                     ...
                     */
                            ...
                            public  br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteRecepcaoLoteResult cteRecepcaoLote(

                            br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteDadosMsg cteDadosMsg0,br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteCabecMsgE cteCabecMsg1)
              ...
              org.apache.axiom.soap.SOAPEnvelope env = null;
                                                    ...
                                                    cteDadosMsg0,
                                                    optimizeContent(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcao",
                                                    "cteRecepcaoLote")), new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcao",
                                                    "cteRecepcaoLote"));
                                        ...
                                        if (cteCabecMsg1!=null){
                                                    ...
                                                    org.apache.axiom.om.OMElement omElementcteCabecMsg1 = toOM(cteCabecMsg1, optimizeContent(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcao", "cteRecepcaoLote")));
               ...
               org.apache.axis2.context.MessageContext _returnMessageContext = _operationClient.getMessageContext(
                ...
                org.apache.axiom.soap.SOAPEnvelope _returnEnv = _returnMessageContext.getEnvelope();
                                ...
                                java.lang.Object object = fromOM(
                                             ...
                                             br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteRecepcaoLoteResult.class,
                                              getEnvelopeNamespaces(_returnEnv));

                               
                                        return (br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteRecepcaoLoteResult)object;
                                   
         }catch(org.apache.axis2.AxisFault f){

            org.apache.axiom.om.OMElement faultElt = f.getDetail();
            if (faultElt!=null){
                if (faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"cteRecepcaoLote"))){
                    //make the fault by reflection
                    try{
                        java.lang.String exceptionClassName = (java.lang.String)faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"cteRecepcaoLote"));
                        java.lang.Class exceptionClass = java.lang.Class.forName(exceptionClassName);
                        java.lang.reflect.Constructor constructor = exceptionClass.getConstructor(String.class);
                        java.lang.Exception ex = (java.lang.Exception) constructor.newInstance(f.getMessage());
                        //message class
                        java.lang.String messageClassName = (java.lang.String)faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(),"cteRecepcaoLote"));
                ...
                * 
                * @see br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcao#startcteRecepcaoLote
                    * @param cteDadosMsg0
                
                    * @param cteCabecMsg1
                
                */
                public  void startcteRecepcaoLote(

                 br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteDadosMsg cteDadosMsg0,br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteCabecMsgE cteCabecMsg1,
                    

                  final br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoCallbackHandler callback)
                        ...
                        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
                            ...
                            try {
                                org.apache.axiom.soap.SOAPEnvelope resultEnv = resultContext.getEnvelope();
                                        ...
                                        callback.receiveResultcteRecepcaoLote(
                                        (br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteRecepcaoLoteResult)object);
    ...
    private boolean optimizeContent(javax.xml.namespace.QName opName) {
     ...
     //https://cte-homologacao.svrs.rs.gov.br/ws/cterecepcao/CteRecepcao.asmx
        ...
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcao",
                "cteCabecMsg",
                "ns1");
    ...
    public static class Factory{
        ...
        */
        ...
        public static class ExtensionMapper{
          ...
          public static java.lang.Object getTypeObject(java.lang.String namespaceURI,
                  ...
                  if (
                  "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcao".equals(namespaceURI) &&
        ...
        /* This type was generated from the piece of schema that had
                name = cteCabecMsg
                Namespace URI = http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcao
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcao");
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localCUFTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcao",
                                                                      "cUF"));
    ...
    public static class Factory{
        ...
        */
        ...
        public static class CteRecepcaoLoteResult
        implements org.apache.axis2.databinding.ADBBean{
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":cteRecepcaoLoteResult",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "cteRecepcaoLoteResult",
    ...
    public static class Factory{
        ...
        *                If this object is a complex type, the reader is positioned at the end element of its outer element
        */
        public static CteRecepcaoLoteResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CteRecepcaoLoteResult object =
                new CteRecepcaoLoteResult();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"cteRecepcaoLoteResult".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CteRecepcaoLoteResult)ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
            ...
            private  org.apache.axiom.om.OMElement  toOM(br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteDadosMsg param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteDadosMsg.MY_QNAME,
            ...
            private  org.apache.axiom.om.OMElement  toOM(br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteRecepcaoLoteResult param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteRecepcaoLoteResult.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
            ...
            private  org.apache.axiom.om.OMElement  toOM(br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteCabecMsgE param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {

            
                        try{
                             return param.getOMElement(br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteCabecMsgE.MY_QNAME,
                                          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
                        } catch(org.apache.axis2.databinding.ADBException e){
                            throw org.apache.axis2.AxisFault.makeFault(e);
                        }
                                        ...
                                        private  org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteDadosMsg param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
                                        throws org.apache.axis2.AxisFault{
                                                    ...
                                                    try{
                                                            ...
                                                            emptyEnvelope.getBody().addChild(param.getOMElement(br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteDadosMsg.MY_QNAME,factory));
        ...
        */
        ...
        try {
                ...
                if (br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteDadosMsg.class.equals(type)){
                
                           return br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                    

                }
           
                if (br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteRecepcaoLoteResult.class.equals(type)){
                
                           return br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteRecepcaoLoteResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
                    

                }
           
                if (br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteCabecMsgE.class.equals(type)){
                
                           return br.inf.portalfiscal.www.cte.wsdl.cterecepcao.CteRecepcaoStub.CteCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
