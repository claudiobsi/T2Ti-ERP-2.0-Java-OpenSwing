...
public class Menu implements MDIController, LoginController {
    ...
    public void loginSuccessful(Map loginInfo) {
        ...
        dominioCategoriaCompromissoCor.addDomainPair("Vermeilho", "Vermeilho");
        ...
        dominioCompromissoRecorrente.addDomainPair(1, "Diário");
        dominioCompromissoRecorrente.addDomainPair(2, "Semanal");
        dominioCompromissoRecorrente.addDomainPair(3, "Mensal");
        dominioCompromissoRecorrente.addDomainPair(4, "Anual");

        Domain dominioFormatoCodBarra = new Domain("formatoCodigoBarra");
        dominioFormatoCodBarra.addDomainPair(0, "EAN");
        dominioFormatoCodBarra.addDomainPair(1, "QR Code");

        Domain dominioOsTipoProdutoServico = new Domain("osTipoProdutoServico");
        dominioOsTipoProdutoServico.addDomainPair(0, "PRODUTO");
        dominioOsTipoProdutoServico.addDomainPair(1, "SERVIÇO");
        
        Domain dominioOsTipoCobertura = new Domain("osTipoCobertura");
        dominioOsTipoCobertura.addDomainPair(0, "NENHUM");
        dominioOsTipoCobertura.addDomainPair(1, "GARANTIA");
        dominioOsTipoCobertura.addDomainPair(2, "SEGURO");
        dominioOsTipoCobertura.addDomainPair(3, "CONTRATO");
        
        Domain dominioNfseNaturezaOperacao = new Domain("nfseNaturezaOperacao");
        dominioNfseNaturezaOperacao.addDomainPair(1, "Tributação no município");
        dominioNfseNaturezaOperacao.addDomainPair(2, "Tributação fora do município");
        dominioNfseNaturezaOperacao.addDomainPair(3, "Isenção");
        dominioNfseNaturezaOperacao.addDomainPair(4, "Imune");
        dominioNfseNaturezaOperacao.addDomainPair(5, "Exigibilidade suspensa por decisão judicial");
        dominioNfseNaturezaOperacao.addDomainPair(6, "Exigibilidade suspensa por procedimento administrativo");

        Domain dominioNfseRegimeEspecialTributacao = new Domain("nfseRegimeEspecialTributacao");
        dominioNfseRegimeEspecialTributacao.addDomainPair(1, "Microempresa Municipal");
        dominioNfseRegimeEspecialTributacao.addDomainPair(2, "Estimativa");
        dominioNfseRegimeEspecialTributacao.addDomainPair(3, "Sociedade de Profissionais");
        dominioNfseRegimeEspecialTributacao.addDomainPair(4, "Cooperativa");
        
        Domain dominioNfseTipoRPS = new Domain("nfseTipoRPS");
        dominioNfseTipoRPS.addDomainPair(1, "Recibo Provisório de Serviços");
        dominioNfseTipoRPS.addDomainPair(2, "RPS Nota Fiscal Conjugada (Mista)");
        dominioNfseTipoRPS.addDomainPair(3, "Cupom");

        Domain dominioCteFormatoImpressaoDacte = new Domain("cteFormatoImpressaoDacte");
        dominioCteFormatoImpressaoDacte.addDomainPair(1, "Retrato");
        dominioCteFormatoImpressaoDacte.addDomainPair(2, "Paisagem");

        Domain dominioCteTipoEmissao = new Domain("cteTipoEmissao");
        dominioCteTipoEmissao.addDomainPair(1, "Normal");
        dominioCteTipoEmissao.addDomainPair(4, "EPEC pela SVC");
        dominioCteTipoEmissao.addDomainPair(5, "Contingência FSDA");
        dominioCteTipoEmissao.addDomainPair(7, "Autorização pela SVC-RS");
        dominioCteTipoEmissao.addDomainPair(8, "Autorização pela SVC-SP");

        Domain dominioCteModal = new Domain("cteModal");
        dominioCteModal.addDomainPair("01", "Rodoviário");
        dominioCteModal.addDomainPair("02", "Aéreo");
        dominioCteModal.addDomainPair("03", "Aquaviário");
        dominioCteModal.addDomainPair("04", "Ferroviário");
        dominioCteModal.addDomainPair("05", "Dutoviário");
        dominioCteModal.addDomainPair("06", "Multimodal");
        
        Domain dominioCteFormaPagamento = new Domain("cteFormaPagamento");
        dominioCteFormaPagamento.addDomainPair(0, "Pago");
        dominioCteFormaPagamento.addDomainPair(1, "A pagar");
        dominioCteFormaPagamento.addDomainPair(2, "Outros");
        
        Domain dominioCteTipoServico = new Domain("cteTipoServico");
        dominioCteTipoServico.addDomainPair(0, "Normal");
        dominioCteTipoServico.addDomainPair(1, "Subcontratação");
        dominioCteTipoServico.addDomainPair(2, "Redespacho");
        dominioCteTipoServico.addDomainPair(3, "Redespacho  Intermediário");
        dominioCteTipoServico.addDomainPair(4, "Serviço Vinculado a  Multimodal");
        
        Domain dominioCteTipo = new Domain("cteTipo");
        dominioCteTipo.addDomainPair(0, "CT-e Normal");
        dominioCteTipo.addDomainPair(0, "CT-e de Complemento de Valores");
        dominioCteTipo.addDomainPair(0, "CT-e de Anulação");
        dominioCteTipo.addDomainPair(0, "CT-e Substituto");
        
        Domain dominioCteTomador = new Domain("cteTomador");
        dominioCteTomador.addDomainPair(0, "Remetente");
        dominioCteTomador.addDomainPair(1, "Expedidor");
        dominioCteTomador.addDomainPair(2, "Recebedor");
        dominioCteTomador.addDomainPair(3, "Destinatário");
        dominioCteTomador.addDomainPair(4, "Outros");
        
        Domain dominioCteTipoPeriodo = new Domain("cteTipoPeriodo");
        dominioCteTipoPeriodo.addDomainPair(0, "Sem data definida");
        dominioCteTipoPeriodo.addDomainPair(1, "Na data");
        dominioCteTipoPeriodo.addDomainPair(2, "Até a data");
        dominioCteTipoPeriodo.addDomainPair(3, "A partir da data");
        dominioCteTipoPeriodo.addDomainPair(4, "No período");

        Domain dominioCteCodigoUnidadeMedida = new Domain("cteCodigoUnidadeMedida");
        dominioCteCodigoUnidadeMedida.addDomainPair("00", "M3");
        dominioCteCodigoUnidadeMedida.addDomainPair("01", "KG");
        dominioCteCodigoUnidadeMedida.addDomainPair("02", "TON");
        dominioCteCodigoUnidadeMedida.addDomainPair("03", "UNIDADE");
        dominioCteCodigoUnidadeMedida.addDomainPair("04", "LITROS");
        dominioCteCodigoUnidadeMedida.addDomainPair("05", "MMBTU");
        
        Domain dominioWmsDestino = new Domain("wmsDestino");
        dominioWmsDestino.addDomainPair("A", "ARMAZENAMENTO");
        dominioWmsDestino.addDomainPair("E", "EXPEDICAO");
        dominioWmsDestino.addDomainPair("P", "PRODUCAO");
        
        Domain dominioWmsOrigemOrdemSeparacao = new Domain("wmsOrigemOrdemSeparacao");
        dominioWmsOrigemOrdemSeparacao.addDomainPair("P", "PRODUCAO");
        dominioWmsOrigemOrdemSeparacao.addDomainPair("M", "MATRIZ");
        dominioWmsOrigemOrdemSeparacao.addDomainPair("F", "FILIAL");
        ...
        domains.put(dominioFormatoCodBarra.getDomainId(), dominioFormatoCodBarra);
        domains.put(dominioOsTipoProdutoServico.getDomainId(), dominioOsTipoProdutoServico);
        domains.put(dominioOsTipoCobertura.getDomainId(), dominioOsTipoCobertura);
        domains.put(dominioNfseNaturezaOperacao.getDomainId(), dominioNfseNaturezaOperacao);
        domains.put(dominioNfseRegimeEspecialTributacao.getDomainId(), dominioNfseRegimeEspecialTributacao);
        domains.put(dominioNfseTipoRPS.getDomainId(), dominioNfseTipoRPS);
        domains.put(dominioCteFormatoImpressaoDacte.getDomainId(), dominioCteFormatoImpressaoDacte);
        domains.put(dominioCteTipoEmissao.getDomainId(), dominioCteTipoEmissao);
        domains.put(dominioCteModal.getDomainId(), dominioCteModal);
        domains.put(dominioCteFormaPagamento.getDomainId(), dominioCteFormaPagamento);
        domains.put(dominioCteTipoServico.getDomainId(), dominioCteTipoServico);
        domains.put(dominioCteTipo.getDomainId(), dominioCteTipo);
        domains.put(dominioCteTomador.getDomainId(), dominioCteTomador);
        domains.put(dominioCteTipoPeriodo.getDomainId(), dominioCteTipoPeriodo);
        domains.put(dominioCteCodigoUnidadeMedida.getDomainId(), dominioCteCodigoUnidadeMedida);
        domains.put(dominioWmsDestino.getDomainId(), dominioWmsDestino);
        domains.put(dominioWmsOrigemOrdemSeparacao.getDomainId(), dominioWmsOrigemOrdemSeparacao);
