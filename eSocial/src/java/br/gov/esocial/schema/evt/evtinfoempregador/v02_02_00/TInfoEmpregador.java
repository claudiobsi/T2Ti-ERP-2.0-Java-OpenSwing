...
@XmlType(name = "TInfoEmpregador", propOrder = {
    "nmRazao",
    "classTrib",
    "natJurid",
    "indCoop",
...
public class TInfoEmpregador {
    ...
    @XmlElement(required = true)
    protected String multTabRubricas;
    @XmlElement(required = true)
    protected String indEntEd;
    @XmlElement(required = true)
    protected String indEtt;
    @XmlElement(required = true)
    protected BigInteger nrRegEtt;
    ...
    /**
     * Obtém o valor da propriedade multTabRubricas.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    public String getMultTabRubricas() {
        return multTabRubricas;
    }

    /**
     * Define o valor da propriedade multTabRubricas.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setMultTabRubricas(String value) {
        this.multTabRubricas = value;
    }
     ...
     *     
     */
    public void setNrRegEtt(BigInteger value) {
        this.nrRegEtt = value;
    }
