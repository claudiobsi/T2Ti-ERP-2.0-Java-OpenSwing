...
public class Menu implements MDIController, LoginController {
    ...
    public void loginSuccessful(Map loginInfo) {
        ...
        Domain dominioComissaoFormaPagamento = new Domain("comissaoFormaPagamento");
        dominioComissaoFormaPagamento.addDomainPair("0", "Fixo");
        dominioComissaoFormaPagamento.addDomainPair("1", "Percentual");
        ...
        domains.put(dominioComissaoFormaPagamento.getDomainId(), dominioComissaoFormaPagamento);
